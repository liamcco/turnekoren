import {
	getNextUpcomingStayId,
	getRoomsForStay,
	getStays,
} from '@/app/rooms/rooms'
...
export default async function RoomsPage({
	...
	const rooms = await getRoomsForStay(
		selectedStayId,
	)
				...
				<CardHeader>
					<div className='flex flex-col gap-3 md:flex-row md:items-center md:justify-between'>
						<div className='space-y-2'>
							<Badge
								className='w-fit rounded-full px-3 py-1 text-[10px] tracking-[0.24em] uppercase'
								variant='outline'
							>
								{
									selectedStay.name
